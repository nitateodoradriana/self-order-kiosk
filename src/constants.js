...
export const ORDER_PREPARE_NEXT = 'ORDER_PREPARE_NEXT';
export const ORDER_PREPARE_COMPLETE = 'ORDER_PREPARE_COMPLETE';
export const SET_CURRENT_DRINK_INDEX = 'SET_CURRENT_DRINK_INDEX';